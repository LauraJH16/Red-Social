$(document).ready(function() {
  ...
  $('input[type=file]').change(function() {
    ...
    reader.onload = function(e) {
      $('.content-text').append('<div class="posteando card flow-text"> <img class="img-file img-post center-block" src="#"> <br><br><span class="grey-text">Publicado a las :' + getTime() + '</span><br><br><a href="#!" class="secondary-content"><i class="material-icons">favorite_border</i></a></div></div>');
  ...
  $('.postext').on('click', function() {
    ...
    $('.content-text').append('<div class="col l10 offset-l1 posteando card flow-text">' + $content + '<br><br><span class="grey-text">Publicado a las :' + getTime() + '</span><br><a href="#!" class="secondary-content like"><i class="material-icons">favorite_border</i><span class="count">0</span></a></div>');
    $('#test4').append('<div class="posteando card flow-text col s12">' + $content + '<br><br><span class="grey-text">Publicado a las :' + getTime() + '</span><br><br></div>');
    $('#textarea1').val('');
  });
